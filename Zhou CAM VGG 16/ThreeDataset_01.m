...
% HealthyFolder
AbnormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Crop Images\Enfermos';
resultsAbnormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Enfermos Crop ISSSTE - copia';


% SickFolder

NormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Crop Images\Sanos';
resultsNormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Sanos Crop ISSSTE';
% 
% % Abnormal Folder
% AbnormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Train - Valid Bra+IJC+ISSSTE\Validation Unbalanced Class\Abnormal';
% resultsAbnormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Abnormal Validation';
% 
% NormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Train - Valid Bra+IJC+ISSSTE\Validation Unbalanced Class\Normal';
% resultsNormalValFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Normal Validation';
% 
% % Training Folders
% AbnormalTrainFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Train - Valid Bra+IJC+ISSSTE\Training Unbalanced Class\Abnormal';
% resultsAbnormalTrainFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Abnormal Training';
% 
% NormalTrainFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Data Augmented Thermography\Train - Valid Bra+IJC+ISSSTE\Training Unbalanced Class\Normal';
% resultsNormalTrainFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Results\CAM\Normal Training';

% resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\CAM Test\VGG Thermograms One Class';
codeFolder = 'C:\Users\LANCYTT\Documents\Juan Carlos Torres\Thermograms Analysis\Zhou CAM VGG 16';
addpath('C:\Users\LANCYTT\Documents\Juan Carlos Torres\Thermograms Analysis');

% Load the VGG16_CAM Architecture
load ('C:\Users\LANCYTT\Documents\Juan Carlos Torres\Zhou CAM\VGG16_CAM_Modified.mat')
...
%          movefile(currentFile, nameFile) 
                    ...
                    saveas(CAM_Thermogram, [currentFile , '.tif']);
                    close all  
...
%          movefile(currentFile, nameFile) 
                    ...
                    saveas(CAM_Thermogram, [FileName , '.tif']);
                    close all  
