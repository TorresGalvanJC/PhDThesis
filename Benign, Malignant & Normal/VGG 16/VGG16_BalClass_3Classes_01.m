...
% Folders Location
codeFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\MATLAB Codigos\Benign, Malignant & Normal\VGG 16';
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\VGG 16\Balanced Class';
...
ioi_text_waitbar(qq/nLoops, sprintf('VGG 16 Balanced Class, Running loop %d from %d', qq, nLoops));
