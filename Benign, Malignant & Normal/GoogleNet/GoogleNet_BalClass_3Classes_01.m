%%
% *GoogleNet Data Augmented 200 Brasil+IJC *
clear, close all, clc;

% Folders Location
codeFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\MATLAB Codigos\Benign, Malignant & Normal\GoogleNet';
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\GoogleNet\Balanced Class';
...
for qq = 1:nLoops
    ...
    ioi_text_waitbar(qq/nLoops, sprintf('GoogleNet Balanced Class, Running loop %d from %d', qq, nLoops));
