...
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\GoogleNet\500 Times';
...
for qq = 1:nLoops
    ...
    ioi_text_waitbar(qq/nLoops, sprintf('GoogleNet 500, Running loop %d from %d', qq, nLoops));
