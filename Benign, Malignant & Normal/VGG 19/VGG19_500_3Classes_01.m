...
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\VGG 19\500 Times';
...
%     cd(codeFolder)
    ...
    ioi_text_waitbar(qq/nLoops, sprintf('VGG 19 500, Running loop %d from %d', qq, nLoops));
