...
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\Inception V3\500 Times';
...
%     cd(codeFolder)
    ...
    ioi_text_waitbar(qq/nLoops, sprintf('Inception V3 500, Running loop %d from %d', qq, nLoops));
