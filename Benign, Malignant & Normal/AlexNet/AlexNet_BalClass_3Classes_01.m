...
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\AlexNet\Balanced Class';
...
%     end
    ...
    ioi_text_waitbar(qq/nLoops, sprintf('AlexNet Balanced Class, Running loop %d from %d', qq, nLoops));
