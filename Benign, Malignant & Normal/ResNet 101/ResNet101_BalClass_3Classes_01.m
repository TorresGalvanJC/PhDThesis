...
% Folders Location
codeFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\MATLAB Codigos\Benign, Malignant & Normal\ResNet 101';
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\ResNet 101\Balanced Class';
...
ioi_text_waitbar(qq/nLoops, sprintf('ResNet101 Balanced Class, Running loop %d from %d', qq, nLoops));
