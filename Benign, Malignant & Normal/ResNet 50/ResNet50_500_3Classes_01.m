...
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\ResNet 50\500 Times';
...
ioi_text_waitbar(qq/nLoops, sprintf('ResNet50 500, Running loop %d from %d', qq, nLoops));
