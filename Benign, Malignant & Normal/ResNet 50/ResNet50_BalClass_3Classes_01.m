%%
% *ResNet-50 Data Augmented 200 times Brasil + IJC*

clear, close all, clc;

% Folders Location
codeFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\MATLAB Codigos\Benign, Malignant & Normal\ResNet 50';
resultsFolder = 'K:\Archivos Juan Carlos Torres\MATLAB\Deep Learning\Termogramas\Tumors\ResNet 50\Balanced Class';
...
ioi_text_waitbar(qq/nLoops, sprintf('ResNet50 Balanced Class, Running loop %d from %d', qq, nLoops));
